<div class="cs-flex">
    ...
    <div class="cs-flex">
        <?php if ($this->dx_auth->is_logged_in() && $this->dx_auth->get_user_id() == $user_id) {?>
            <?=anchor("/extensions/edit/$id", "Edit", "class='cs-button cs-button-sm'")?>&nbsp;
            <?=anchor("/extensions/delete/$id", "Delete", "class='cs-button cs-button-sm', onClick=\"return confirm('Are you sure you want to delete this extension?\\nAll comments and information about this extension will be permanently lost.')\"")?>&nbsp;
        <?php } ?>
