<div id="main">
	...
	<h1 class="page-title">Upload a new extension</h1>	

<b><font color="red"><?php echo validation_errors(); ?></font></b>

<b><font color="red"><?=$error?></font></b>

<?php echo form_open_multipart('extensions/create_new_save');?>
    <table>
	...
	<tr><th>UUID</th><td><input type=text size=50 name="uuid" value="<?php echo set_value('uuid'); ?>" /></td></tr>
