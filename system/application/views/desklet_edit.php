...
<div id="main">
        	<div id="post-content" class="clearfix">
				        		<h1 class="page-title">Edit desklet</h1>	

<?php if ($this->dx_auth->is_logged_in() && $this->dx_auth->get_user_id() == $user) {?>

    <b><font color="red"><?=$error?></font></b><br/><br/>
    
    <?php echo form_open_multipart("desklets/edit_save/$id");?>
        <table>	
        <tr><th>Desklet</th><td><input type="file" name="file" size="30"> (.zip, 10MB max) </td></tr>
    ...
    <br/><br/>
    <p>Note: Leave the screenshot/desklet/icon fields empty unless you want to overwrite the files with new ones.</p>
